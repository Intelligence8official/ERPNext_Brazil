...
def fetch_documents(company=None, document_type=None):
    ...
    """
    from brazil.services.fiscal.dfe_client import fetch_documents_for_company

    if company:
        return fetch_documents_for_company(company, document_type)
    else:
        from brazil.services.fiscal.dfe_client import scheduled_fetch
        scheduled_fetch()
...
def process_nota_fiscal(nota_fiscal_name):
    ...
    """
    from brazil.services.fiscal.processor import NFProcessor
...
def create_purchase_invoice(nota_fiscal_name, submit=False):
    ...
    """
    from brazil.services.fiscal.invoice_creator import InvoiceCreator
...
def validate_chave_acesso(chave):
    ...
    """
    from brazil.utils.chave_acesso import validate_chave_acesso as validate, parse_chave_acesso
...
def test_company_connection(company_settings_name):
    ...
    Returns:
        dict: Test result
    """
    from brazil.services.fiscal.dfe_client import test_sefaz_connection
...
def get_balance(company_account_name: str) -> dict:
    ...
    from brazil.services.banking.statement_sync import update_balance
...
def create_boleto(
    ...
    from brazil.services.banking.boleto_service import create_boleto_from_invoice
    from datetime import date
...
def create_pix_charge(
    ...
    from brazil.services.banking.pix_service import create_pix_charge_from_invoice
...
def execute_payment(payment_order_name: str) -> dict:
    ...
    from brazil.services.banking.payment_service import execute_payment_order
...
def webhook_receiver() -> dict:
    ...
    """
    from brazil.services.banking.webhook_handler import process_webhook
...
def test_connection(company_account_name: str) -> dict:
    ...
    from brazil.services.banking.auth_manager import InterAuthManager
...
def register_webhook(company_account_name: str) -> dict:
    ...
    from brazil.services.banking.webhook_handler import register_webhook_for_account
