...
from brazil.services.fiscal.cert_utils import CertificateContext
...
def scheduled_fetch():
    ...
    from brazil.fiscal.doctype.nf_company_settings.nf_company_settings import get_all_enabled_companies
...
def fetch_documents_for_company(company_settings_name, document_type=None):
    ...
    Returns:
        dict: Fetch results
    """
    from brazil.fiscal.doctype.nf_company_settings.nf_company_settings import get_company_settings
    from brazil.fiscal.doctype.nf_import_log.nf_import_log import create_import_log
