...
def _handle_pix_received(data: dict, log) -> dict:
    ...
    for pix in pix_list:
        ...
        if charge_name:
            ...
            from brazil.services.banking.pix_service import _handle_pix_payment
...
def _handle_boleto_paid(data: dict, log) -> dict:
    ...
    if boleto_name:
        ...
        from brazil.services.banking.boleto_service import _handle_boleto_payment
...
def register_webhook_for_account(company_account_name: str) -> dict:
    ...
    webhook_url = f"{site_url}/api/method/brazil.api.webhook_receiver"
