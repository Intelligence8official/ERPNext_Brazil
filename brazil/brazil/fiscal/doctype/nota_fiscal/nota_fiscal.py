...
class NotaFiscal(Document):
    ...
    def validate_chave_de_acesso(self):
        ...
        from brazil.utils.chave_acesso import validate_chave_acesso, clean_chave
    ...
    def validate_cnpj(self):
        ...
        from brazil.utils.cnpj import validate_cnpj, clean_cnpj
    ...
    def create_items(self):
        ...
        from brazil.services.fiscal.item_manager import ItemManager
