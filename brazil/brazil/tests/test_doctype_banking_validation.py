...
# Import controllers
from brazil.bancos.doctype.inter_company_account.inter_company_account import InterCompanyAccount
from brazil.bancos.doctype.inter_payment_order.inter_payment_order import InterPaymentOrder
from brazil.bancos.doctype.inter_boleto.inter_boleto import InterBoleto
from brazil.bancos.doctype.inter_pix_charge.inter_pix_charge import InterPIXCharge
from brazil.bancos.doctype.banco_inter_settings.banco_inter_settings import BancoInterSettings
from brazil.bancos.doctype.inter_api_log.inter_api_log import InterAPILog
from brazil.bancos.doctype.inter_sync_log.inter_sync_log import InterSyncLog
from brazil.bancos.doctype.inter_webhook_log.inter_webhook_log import InterWebhookLog
...
class TestInterCompanyAccountValidation(unittest.TestCase):
    ...
    def test_expired_cert_marks_invalid(self):
        ...
        with patch("brazil.bancos.doctype.inter_company_account.inter_company_account.os.path.exists", return_value=True):
            with patch("brazil.services.banking.auth_manager.resolve_frappe_file_path", side_effect=lambda x: x):
...
class TestLogValidation(unittest.TestCase):
    ...
    def test_api_log_defaults_timestamp(self):
        ...
        with patch("brazil.bancos.doctype.inter_api_log.inter_api_log.now_datetime", return_value=_NOW):
            log.before_insert()
    ...
    def test_sync_log_defaults_started_at(self):
        ...
        log.started_at = None
        with patch("brazil.bancos.doctype.inter_sync_log.inter_sync_log.now_datetime", return_value=_NOW):
            log.before_insert()
    ...
    def test_webhook_log_defaults_received_at(self):
        ...
        with patch("brazil.bancos.doctype.inter_webhook_log.inter_webhook_log.now_datetime", return_value=_NOW):
            log.before_insert()
