...
for mod in [
    "brazil.services.banking.pix_service",
    "brazil.services.banking.boleto_service",
    "brazil.services.banking.inter_client",
    "brazil.services.banking.auth_manager",
]:
    sys.modules.setdefault(mod, MagicMock())

import frappe
from brazil.services.banking.webhook_handler import (
    _identify_event_type,
    process_webhook,
    _handle_pix_received,
    _handle_boleto_paid,
)
import brazil.services.banking.webhook_handler as _wh_mod
