...
from brazil.services.fiscal.processor import NFProcessor, process_nota_fiscal_background
...
class TestNFProcessorPipeline(unittest.TestCase):
    ...
    @patch("brazil.services.fiscal.invoice_creator.InvoiceCreator")
    @patch("brazil.services.fiscal.po_matcher.POMatcher")
    @patch("brazil.services.fiscal.item_manager.ItemManager")
    @patch("brazil.services.fiscal.supplier_manager.SupplierManager")
...
class TestEmailToNfPipeline(unittest.TestCase):
    ...
    @patch("brazil.services.fiscal.email_monitor.get_file_content")
    @patch("brazil.services.fiscal.xml_parser.NFXMLParser")
    ...
    @patch("brazil.services.fiscal.email_monitor.get_file_content")
    @patch("brazil.services.fiscal.email_monitor.extract_xml_from_pdf")
    @patch("brazil.services.fiscal.xml_parser.NFXMLParser")
    ...
    @patch("brazil.services.fiscal.email_monitor.get_file_content")
    @patch("brazil.services.fiscal.email_monitor.create_nf_from_xml")
