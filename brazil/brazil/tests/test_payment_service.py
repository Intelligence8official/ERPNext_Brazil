...
import brazil.services.banking.payment_service as _ps_mod
from brazil.services.banking.payment_service import (
...
class TestExecutePaymentOrder(unittest.TestCase):
    ...
    def test_failed_status_on_error(self):
        ...
        with patch("brazil.services.banking.inter_client.InterAPIClient", return_value=mock_client):
            result = execute_payment_order("PO-001")
