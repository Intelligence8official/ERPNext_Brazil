...
from brazil.services.fiscal.cert_utils import (
    cleanup_temp_files,
...
class TestCleanupTempFiles(unittest.TestCase):
    ...
    @patch("brazil.services.fiscal.cert_utils.os.unlink")
    @patch("brazil.services.fiscal.cert_utils.os.path.exists", return_value=True)
    ...
    @patch("brazil.services.fiscal.cert_utils.os.unlink")
    @patch("brazil.services.fiscal.cert_utils.os.path.exists", return_value=False)
    ...
    @patch("brazil.services.fiscal.cert_utils.os.unlink", side_effect=OSError("Permission denied"))
    @patch("brazil.services.fiscal.cert_utils.os.path.exists", return_value=True)
...
class TestResolveFrappeFilePath(unittest.TestCase):
    ...
    @patch("brazil.services.fiscal.cert_utils.os.path.exists", return_value=True)
    @patch("brazil.services.fiscal.cert_utils.os.path.isabs", return_value=True)
    ...
    @patch("brazil.services.fiscal.cert_utils.os.path.exists")
    @patch("brazil.services.fiscal.cert_utils.os.path.isabs", return_value=False)
...
class TestExtractCertAndKeyFromPfxBytes(unittest.TestCase):
    ...
    @patch("brazil.services.fiscal.cert_utils.tempfile.NamedTemporaryFile")
    @patch("brazil.services.fiscal.cert_utils.load_key_and_certificates")
...
class TestValidatePfxCertificate(unittest.TestCase):
    ...
    @patch("brazil.services.fiscal.cert_utils.load_key_and_certificates")
    @patch("brazil.services.fiscal.cert_utils.get_pfx_bytes_from_file", return_value=b"pfx_data")
...
class TestCertificateContext(unittest.TestCase):
    ...
    @patch("brazil.services.fiscal.cert_utils.cleanup_temp_files")
    @patch("brazil.services.fiscal.cert_utils.extract_cert_and_key_from_file")
