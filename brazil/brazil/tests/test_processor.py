...
_mocked_deps = {}
_dep_modules = [
    "brazil.services.fiscal.supplier_manager",
    "brazil.services.fiscal.item_manager",
    "brazil.services.fiscal.po_matcher",
    "brazil.services.fiscal.invoice_creator",
]
...
from brazil.services.fiscal.processor import (
    NFProcessor,
    process_new_nf,
...
class TestNFProcessorInit(unittest.TestCase):
    def test_init_loads_settings(self):
        with patch("brazil.services.fiscal.processor.frappe") as mock_frappe:
