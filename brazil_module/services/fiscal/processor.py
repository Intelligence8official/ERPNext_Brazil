...
def process_new_nf(doc, method=None):
    ...
    frappe.enqueue(
        "brazil_module.services.fiscal.processor.process_nota_fiscal_background",
        nf_name=doc.name,
        queue="short"
    )
...
def cleanup_old_logs():
    ...
    """
    from brazil_module.fiscal.doctype.nf_import_log.nf_import_log import cleanup_old_logs as cleanup
