...
import brazil_module.services.intelligence.notifications as _notif_mod
...
class TestNotifyDesk(unittest.TestCase):
    def setUp(self):
        ...
        # Ensure module-level frappe reference matches our mock
        _notif_mod.frappe = frappe

    def test_creates_notification_log(self):
        _notif_mod.notify_desk("Test Title", "Test Message")
    ...
    def test_sets_subject_and_content(self):
        _notif_mod.notify_desk("My Title", "My Message")
    ...
    def test_sets_document_link(self):
        _notif_mod.notify_desk("Title", "Msg", document_type="Purchase Order", document_name="PO-001")
